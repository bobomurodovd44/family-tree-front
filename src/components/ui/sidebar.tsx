...
function SidebarProvider({
  ...
  // Internal open state; the `open` prop (if provided) is the source of truth.
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Persist the collapsed/expanded choice so it survives navigation and reloads.
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Spacer that pushes the inset over by the sidebar's width. */}
      <div
